...
# supposed to work for the HC-SR04 sensor
...
def distance():
    ...
    """ note: Never get to the second pulse. 
        Looks like the input never gets to 1
        When I print GPIO.input(PIN_ECHO), it's always zero. never gets beyond that
